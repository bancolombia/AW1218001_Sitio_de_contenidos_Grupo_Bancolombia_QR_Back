...
public class QrControllerImplSendQrTest {
	...
	private DataResponseShipping dataResponseShipping;
	...
	public void setUp() throws JsonParseException, JsonMappingException, IllegalArgumentException, IOException,
		...
		sb.append("            \"document\": {\r\n");
		sb.append("                \"documentType\": \"CC\",\r\n");
		sb.append("                \"documentNumber\": 12345678890\r\n");
		sb.append("            }\r\n");
		sb.append("        }\r\n");
		sb.append("    },\r\n");
		...
		data = new ObjectMapper().convertValue(new ObjectMapper().readValue(sb.toString(), DataSendQr.class),
				Map.class);

		dataSendQr = new DataSendQr();
		...
		dataResponseShipping = new DataResponseShipping();
	...
	@Test
	public void sendQrOKTest() throws IOException, TranscoderException,
		...
		dataSendQr = mapper.convertValue(request.getData(), DataSendQr.class);

		when(validateRequestServiceSendQr.getData(ArgumentMatchers.any(HttpServletRequest.class),
				ArgumentMatchers.any(RequestOld.class), ArgumentMatchers.eq(DataSendQr.class))).thenReturn(dataSendQr);
		...
		when(service.sendQRData(ArgumentMatchers.any(RequestShipping.class)))
				.thenReturn(dataResponseShipping);
		...
		ResponseEntity<Response> response = controller.sendQr(request);
		assertEquals(HttpStatus.OK, response.getStatusCode());
	}

	@Test
	public void sendQrInvalidRequestTest() throws RequestException, SqsMessageException, JsonMapperException {
		...
		when(validateRequestServiceSendQr.getData(ArgumentMatchers.any(HttpServletRequest.class),
				ArgumentMatchers.any(RequestOld.class), ArgumentMatchers.eq(DataSendQr.class)))
	...
	@Test
	public void sendQrInvalidRequestWithResponseTest() throws RequestException, SqsMessageException, JsonMapperException {
